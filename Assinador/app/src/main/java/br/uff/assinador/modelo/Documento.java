package br.uff.assinador.modelo;
...
public class Documento {
    ...
    public Documento(Long id, String nome, String tipo, byte[] arquivo, byte[] assinatura, byte[] tipo_assinatura, java.util.Date data, long usuarioId) {
        this.id = id;
        this.nome = nome;
        this.tipo = tipo;
    ...
    public byte[] getTipo_assinatura() {
        return tipo_assinatura;
    }

    public void setTipo_assinatura(byte[] tipo_assinatura) {
        this.tipo_assinatura = tipo_assinatura;
    }
