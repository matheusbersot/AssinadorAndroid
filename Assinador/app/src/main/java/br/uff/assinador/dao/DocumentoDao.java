...
public class DocumentoDao extends AbstractDao<Documento, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Arquivo = new Property(4, byte[].class, "arquivo", false, "ARQUIVO");
        public final static Property Assinatura = new Property(5, byte[].class, "assinatura", false, "ASSINATURA");
        public final static Property Tipo_assinatura = new Property(6, String.class, "tipo_assinatura", false, "TIPO_ASSINATURA");
        public final static Property Data = new Property(7, java.util.Date.class, "data", false, "DATA");
        public final static Property UsuarioId = new Property(8, long.class, "usuarioId", false, "USUARIO_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DOCUMENTO\" (" + //
                ...
                "\"ARQUIVO\" BLOB NOT NULL ," + // 4: arquivo
                "\"ASSINATURA\" BLOB," + // 5: assinatura
                "\"TIPO_ASSINATURA\" TEXT," + // 6: tipo_assinatura
                "\"DATA\" INTEGER," + // 7: data
                "\"USUARIO_ID\" INTEGER NOT NULL );"); // 8: usuarioId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Documento entity) {
        ...
        stmt.bindBlob(5, entity.getArquivo());
 
        byte[] assinatura = entity.getAssinatura();
        if (assinatura != null) {
            stmt.bindBlob(6, assinatura);
        }
 
        String tipo_assinatura = entity.getTipo_assinatura();
        if (tipo_assinatura != null) {
            stmt.bindString(7, tipo_assinatura);
        }
 
        java.util.Date data = entity.getData();
        if (data != null) {
            stmt.bindLong(8, data.getTime());
        }
        stmt.bindLong(9, entity.getUsuarioId());
    }
    ...
    public Documento readEntity(Cursor cursor, int offset) {
        Documento entity = new Documento( //
            ...
            cursor.getBlob(offset + 4), // arquivo
            cursor.isNull(offset + 5) ? null : cursor.getBlob(offset + 5), // assinatura
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // tipo_assinatura
            cursor.isNull(offset + 7) ? null : new java.util.Date(cursor.getLong(offset + 7)), // data
            cursor.getLong(offset + 8) // usuarioId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Documento entity, int offset) {
        ...
        entity.setArquivo(cursor.getBlob(offset + 4));
        entity.setAssinatura(cursor.isNull(offset + 5) ? null : cursor.getBlob(offset + 5));
        entity.setTipo_assinatura(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setData(cursor.isNull(offset + 7) ? null : new java.util.Date(cursor.getLong(offset + 7)));
        entity.setUsuarioId(cursor.getLong(offset + 8));
     }
